...
interface ActivityFeedModeProps {
  currentUser: Profile
  onMatchFound: (match: Match) => void
}

const ActivityFeedMode: React.FC<ActivityFeedModeProps> = ({ currentUser, onMatchFound }) => {
...
export default ActivityFeedMode
