...
interface ExploreMapModeProps {
  currentUser: Profile
  onMatchFound: (match: Match) => void
}

const ExploreMapMode: React.FC<ExploreMapModeProps> = ({ currentUser, onMatchFound }) => {
