...
interface GroupMatchModeProps {
  currentUser: Profile
  onMatchFound: (match: Match) => void
}

const GroupMatchMode: React.FC<GroupMatchModeProps> = ({ currentUser, onMatchFound }) => {
