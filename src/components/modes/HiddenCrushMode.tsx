...
interface HiddenCrushModeProps {
  currentUser: Profile
  onMatchFound: (match: Match) => void
}

const HiddenCrushMode: React.FC<HiddenCrushModeProps> = ({ currentUser, onMatchFound }) => {
...
export default HiddenCrushMode
